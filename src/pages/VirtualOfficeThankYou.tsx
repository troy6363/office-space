        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-slate-600 font-light mb-2">
              We've received your inquiry about our Virtual Office solution
            </p>
            <p className="text-lg text-slate-500">
              Our team will contact you shortly to discuss how we can help elevate your business presence.
            </p>
          </div>

          <div className="bg-white rounded-2xl shadow-xl overflow-hidden mb-8 p-4">
            <VideoPlayer videoId="1137893488" title="Virtual Office Tour" />
          </div>
            ...
            <div className="space-y-4">
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-slate-600">Our team will carefully review your information and requirements.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <div className="flex-shrink-0 w-8 h-8 bg-cyan-100 rounded-full flex items-center justify-center text-cyan-600 font-bold">
                ...
                <div>
                  <h3 className="font-semibold text-slate-900 mb-1">Personalized Follow-Up</h3>
                  <p className="text-slate-600">We'll contact you within 24 hours to schedule a detailed consultation.</p>
                </div>
              </div>
              <div className="flex gap-4">
                <div className="flex-shrink-0 w-8 h-8 bg-cyan-100 rounded-full flex items-center justify-center text-cyan-600 font-bold">
                ...
                <div>
                  ...
                  <p className="text-slate-600">Once approved, you can start using your virtual office right away!</p>
                </div>
              </div>
            </div>
          </div>
